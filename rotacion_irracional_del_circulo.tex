\section{Propiedades de la rotación irracional del círculo}
...
\begin{lema}
	...
	entonces si \eqref{birkhoff_eq} se cumple para cualquier función continua.
\end{lema}
...
\begin{proof}
	...
	Luego $f$ tiene una única medida de probabilidad invariante y ergódica. Esta medida es la medida de Lebesgue.
\end{proof}
